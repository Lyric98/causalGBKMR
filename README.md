# causalGBKMR: Causal Inference for Time-Varying Environmental Mixtures via g-BKMR

## About the Method

`causalGBKMR` implements **g-BKMR**, a method for estimating the causal
...
[Methodology Overview](https://lyric98.github.io/causalGBKMR/articles/gbkmr_method_overview.html).
...
Install `causalGBKMR` from GitHub:
...
See the [Quick Start guide](https://lyric98.github.io/causalGBKMR/articles/gbkmr_quickstart.html)
...
| Topic | Link |
|-------|------|
| Methodology overview | [Method](https://lyric98.github.io/causalGBKMR/articles/gbkmr_method_overview.html) |
| Quick start | [Quick Start](https://lyric98.github.io/causalGBKMR/articles/gbkmr_quickstart.html) |
| Custom contrasts | [Example 1](https://lyric98.github.io/causalGBKMR/articles/gbkmr_example_contrasts.html) |
| Binary outcome | [Example 2](https://lyric98.github.io/causalGBKMR/articles/gbkmr_example_binary.html) |
| Large-sample fastBKMR | [Example 3](https://lyric98.github.io/causalGBKMR/articles/gbkmr_example_fastbkmr.html) |
| Diagnostics & troubleshooting | [Diagnostics](https://lyric98.github.io/causalGBKMR/articles/gbkmr_diagnostics.html) |
| Function reference | [Functions](https://lyric98.github.io/causalGBKMR/reference/) |

## Citation

If you use `causalGBKMR` in your research, please cite the method paper
(Chai et al., g-BKMR) and the software paper (forthcoming).

## Related Packages

`causalGBKMR` is part of a broader effort to make causal inference
...
- `causalGBKMR` *(this package)* — g-formula + BKMR for time-varying mixtures
